            ...
            <div className="card-body">
              ...
              <div className="direct-chat-messages">
                ...
                <div className="direct-chat-msg">
                  ...
                  {/* /.direct-chat-infos */}
                  <img className="direct-chat-img" src="dist/img/user1-128x128.jpg" alt="message user img" />
                  {/* /.direct-chat-img */}
                ...
                <div className="direct-chat-msg right">
                  ...
                  {/* /.direct-chat-infos */}
                  <img className="direct-chat-img" src="dist/img/user3-128x128.jpg" alt="message user img" />
                  {/* /.direct-chat-img */}
                  <div className="direct-chat-text">
