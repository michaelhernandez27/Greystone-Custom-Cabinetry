...
class Profile extends Component {
  ...
  getData = async id => {
    await axios
      ...
      .then(response => {
        ...
        document.getElementById("avatars").src = "http://localhost:5000/images/"+response.data.avatars
  ...
  showForm = ({
    ...
    return (
      <form role="button" onSubmit={handleSubmit}>
            ...
            <div className="input-group">
              <div className="custom-file">
                <input
                  ...
                  accept="image/*"
                  id="avatars"
                  className1="custom-file-input"
                  id1="exampleInputFile"
                />
